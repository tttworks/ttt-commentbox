...
![Elementor Widgets Panel](assets/screenshots/01-elementor-widgets-panel.png)
*Elementor Widgets Panel — Search "TTT" to find both widgets*

![Elementor Widget Settings](assets/screenshots/02-elementor-widget-settings.png)
*Customize titles, colors, avatar size, and like button from the Elementor panel*

![Gutenberg Blocks](assets/screenshots/03-gutenberg-blocks.png)
*Gutenberg Block Editor — blocks under the "TTT CommentBox" category*

![Frontend Comment List](assets/screenshots/04-frontend-comment-list.png)
*Frontend display — comment list with text avatars and AJAX likes*

![Frontend Comment Form](assets/screenshots/05-frontend-comment-form.png)
*Frontend display — comment submission form with SVG submit icon*
...
![Elementor 小组件面板](assets/screenshots/01-elementor-widgets-panel.png)
*Elementor 小组件面板 — 搜索"TTT"找到两个小组件*

![Elementor 小组件设置](assets/screenshots/02-elementor-widget-settings.png)
*自定义标题、颜色、头像大小和点赞按钮*

![Gutenberg 区块](assets/screenshots/03-gutenberg-blocks.png)
*Gutenberg 区块编辑器 — 位于"TTT CommentBox"分类下*

![前端评论列表](assets/screenshots/04-frontend-comment-list.png)
*前端显示 — 带文字头像和 AJAX 点赞的评论列表*

![前端评论表单](assets/screenshots/05-frontend-comment-form.png)
*前端显示 — 带 SVG 提交图标的评论表单*
...
![Elementor ウィジェットパネル](assets/screenshots/01-elementor-widgets-panel.png)
*Elementor ウィジェットパネル — "TTT"で検索して両ウィジェットを見つける*

![Elementor ウィジェット設定](assets/screenshots/02-elementor-widget-settings.png)
*タイトル、色、アバターサイズ、いいねボタンをElementorパネルからカスタマイズ*

![Gutenberg ブロック](assets/screenshots/03-gutenberg-blocks.png)
*Gutenberg ブロックエディター — 「TTT CommentBox」カテゴリ配下*

![フロントエンドコメント一覧](assets/screenshots/04-frontend-comment-list.png)
*フロントエンド表示 — テキストアバターとAJAXいいね付きコメント一覧*

![フロントエンドコメントフォーム](assets/screenshots/05-frontend-comment-form.png)
*フロントエンド表示 — SVG送信アイコン付きコメントフォーム*
