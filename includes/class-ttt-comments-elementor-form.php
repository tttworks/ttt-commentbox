...
class TTT_Comments_Form_Widget extends Widget_Base {
    ...
    public function get_name() { return 'ttt-comments-form'; }
    public function get_title() { return __( 'TTT Comments Form', 'ttt-commentbox' ); }
    public function get_icon() { return 'eicon-form-horizontal'; }
    public function get_categories() { return array( 'general' ); }
    public function get_keywords() { return array( 'comment', 'form', 'ttt', 'review', 'feedback' ); }

    protected function register_controls() {

        $this->start_controls_section( 'section_form_title', array(
            'label' => __( 'Form Title', 'ttt-commentbox' ),
            'tab'   => Controls_Manager::TAB_CONTENT,
        ));

        $this->add_control( 'form_title_text', array(
        ...
        $this->add_control( 'form_title_show', array(
        ...
        $this->add_control( 'form_title_color', array(
        ...
        $this->add_control( 'label_name', array( 'label' => __( 'Name Label', 'ttt-commentbox' ), 'type' => Controls_Manager::TEXT, 'default' => __( 'Name', 'ttt-commentbox' ) ));
        $this->add_control( 'label_email', array( 'label' => __( 'Email Label', 'ttt-commentbox' ), 'type' => Controls_Manager::TEXT, 'default' => __( 'Email', 'ttt-commentbox' ) ));
        $this->add_control( 'label_website', array( 'label' => __( 'Website Label', 'ttt-commentbox' ), 'type' => Controls_Manager::TEXT, 'default' => __( 'Website', 'ttt-commentbox' ) ));
        $this->add_control( 'label_comment', array( 'label' => __( 'Comment Label', 'ttt-commentbox' ), 'type' => Controls_Manager::TEXT, 'default' => __( 'Comment', 'ttt-commentbox' ) ));
        $this->add_control( 'label_submit', array( 'label' => __( 'Submit Button Text', 'ttt-commentbox' ), 'type' => Controls_Manager::TEXT, 'default' => __( 'Submit A Comment', 'ttt-commentbox' ) ));
        $this->add_control( 'label_save_info', array(
        ...
        $this->add_control( 'show_website', array(
        ...
        $this->start_controls_section( 'section_style_form', array(
            'label' => __( 'Form Style', 'ttt-commentbox' ),
            'tab'   => Controls_Manager::TAB_STYLE,
        ));

        $this->add_control( 'form_text_color', array(
            'label'   => __( 'Text Color', 'ttt-commentbox' ),
            'type'    => Controls_Manager::COLOR,
            'default' => '#333333',
            'selectors' => array( '{{WRAPPER}} .ttt-comment-form' => 'color: {{VALUE}};' ),
        ));
        ...
        $this->add_responsive_control( 'form_padding', array(
            ...
            'selectors'  => array( '{{WRAPPER}} .ttt-input, {{WRAPPER}} .ttt-textarea' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};' ),
        ));

        $this->add_group_control( Group_Control_Border::get_type(), array( 'name' => 'form_border', 'label' => __( 'Field Border', 'ttt-commentbox' ), 'selector' => '{{WRAPPER}} .ttt-input, {{WRAPPER}} .ttt-textarea' ));

        $this->add_control( 'form_border_radius', array(
            'label'      => __( 'Border Radius', 'ttt-commentbox' ),
            'type'       => Controls_Manager::DIMENSIONS,
            'size_units' => array( 'px', '%' ),
            'selectors'  => array( '{{WRAPPER}} .ttt-input, {{WRAPPER}} .ttt-textarea' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};' ),
        ));
        ...
        $this->add_control( 'submit_text_color', array(
            ...
            'type'    => Controls_Manager::COLOR,
            'default' => '#ffffff',
            'selectors' => array( '{{WRAPPER}} .ttt-submit-btn' => 'color: {{VALUE}};' ),
        ));
        ...
        $this->add_control( 'submit_bg', array(
            ...
            'type'    => Controls_Manager::COLOR,
            'default' => '#007bff',
            'selectors' => array( '{{WRAPPER}} .ttt-submit-btn' => 'background-color: {{VALUE}};' ),
        ));

        $this->add_group_control( Group_Control_Typography::get_type(), array( 'name' => 'submit_typography', 'label' => __( 'Button Typography', 'ttt-commentbox' ), 'selector' => '{{WRAPPER}} .ttt-submit-btn' ));

        $this->add_responsive_control( 'submit_padding', array(
            'label'      => __( 'Button Padding', 'ttt-commentbox' ),
            'type'       => Controls_Manager::DIMENSIONS,
            'size_units' => array( 'px', 'em', '%' ),
            'selectors'  => array( '{{WRAPPER}} .ttt-submit-btn' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};' ),
        ));

        $this->add_group_control( Group_Control_Border::get_type(), array( 'name' => 'submit_border', 'label' => __( 'Button Border', 'ttt-commentbox' ), 'selector' => '{{WRAPPER}} .ttt-submit-btn' ));

        $this->add_control( 'submit_border_radius', array(
            'label'      => __( 'Button Border Radius', 'ttt-commentbox' ),
            'type'       => Controls_Manager::DIMENSIONS,
            'size_units' => array( 'px', '%' ),
            'selectors'  => array( '{{WRAPPER}} .ttt-submit-btn' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};' ),
        ));

        $this->start_controls_tabs( 'submit_tabs' );
        $this->start_controls_tab( 'submit_tab_normal', array( 'label' => __( 'Normal', 'ttt-commentbox' ) ));
        $this->end_controls_tab();
        $this->start_controls_tab( 'submit_tab_hover', array( 'label' => __( 'Hover', 'ttt-commentbox' ) ));
        $this->add_control( 'submit_bg_hover', array(
            'label'   => __( 'Hover Background', 'ttt-commentbox' ),
            'type'    => Controls_Manager::COLOR,
            'default' => '#0056b3',
            'selectors' => array( '{{WRAPPER}} .ttt-submit-btn:hover' => 'background-color: {{VALUE}};' ),
        ));
        $this->end_controls_tab();
    ...
    protected function render() {
        ...
        echo TTT_Comments_Core::render_form( $form_settings );
    }
}
