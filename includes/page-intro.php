...
<div class="ttt-intro-page">

    <!-- Hero -->
    <div class="ttt-intro-hero">
        <div class="ttt-intro-hero-text">
            ...
            <p class="ttt-intro-meta">
                ...
                <span class="ttt-intro-sep">·</span>
                <span><a href="https://github.com/tttworks/ttt-commentbox" target="_blank"><?php esc_html_e( 'GitHub', 'ttt-commentbox' ); ?></a></span>
            </p>
        </div>
        <div class="ttt-intro-hero-visual">💬</div>
    </div>

    <!-- Quick links -->
    <div class="ttt-intro-links">
        <a href="https://github.com/tttworks/ttt-commentbox" target="_blank" class="button"><?php esc_html_e( 'Star on GitHub', 'ttt-commentbox' ); ?></a>
        <a href="https://github.com/tttworks/ttt-commentbox/issues" target="_blank" class="button"><?php esc_html_e( 'Report Bug', 'ttt-commentbox' ); ?></a>
        <a href="https://tttworks.com" target="_blank" class="button"><?php esc_html_e( 'Visit TTTWorks.com', 'ttt-commentbox' ); ?></a>
    </div>

    <!-- Features -->
    <h2 class="ttt-intro-section-title"><?php esc_html_e( 'What TTT CommentBox Does', 'ttt-commentbox' ); ?></h2>
    ...
    <!-- How to Use -->
    <h2 class="ttt-intro-section-title"><?php esc_html_e( 'How to Use', 'ttt-commentbox' ); ?></h2>

    <div class="ttt-intro-howto">

        <!-- Elementor -->
        <div class="ttt-intro-howto-block">
            <h2>🧩 <?php esc_html_e( 'Elementor', 'ttt-commentbox' ); ?></h2>
            ...
            <div class="ttt-intro-steps">
                <div class="ttt-intro-step">
                    <span class="ttt-intro-step-num">1</span>
                    <span><?php esc_html_e( 'Edit any page with Elementor.', 'ttt-commentbox' ); ?></span>
                </div>
                <div class="ttt-intro-step">
                    <span class="ttt-intro-step-num">2</span>
                    <span><?php esc_html_e( 'Search for "TTT" in the widget panel.', 'ttt-commentbox' ); ?></span>
                </div>
                <div class="ttt-intro-step">
                    <span class="ttt-intro-step-num">3</span>
                    <span><?php esc_html_e( 'Drag "TTT Comments List" onto the page to show comments.', 'ttt-commentbox' ); ?></span>
                </div>
                <div class="ttt-intro-step">
                    <span class="ttt-intro-step-num">4</span>
                    <span><?php esc_html_e( 'Drag "TTT Comments Form" onto the page to show the comment form.', 'ttt-commentbox' ); ?></span>
                </div>
                <div class="ttt-intro-step">
                    <span class="ttt-intro-step-num">5</span>
                    <span><?php esc_html_e( 'Use the left-side Settings panel to customize titles, colors, avatar sizes, the like button, and more.', 'ttt-commentbox' ); ?></span>
                </div>
            </div>
        ...
        <!-- Gutenberg -->
        <div class="ttt-intro-howto-block">
            <h2>🧱 <?php esc_html_e( 'Gutenberg', 'ttt-commentbox' ); ?></h2>
            ...
            <div class="ttt-intro-steps">
                <div class="ttt-intro-step">
                    <span class="ttt-intro-step-num">1</span>
                    <span><?php esc_html_e( 'Edit any post or page with the Block Editor.', 'ttt-commentbox' ); ?></span>
                </div>
                <div class="ttt-intro-step">
                    <span class="ttt-intro-step-num">2</span>
                    <span><?php esc_html_e( 'Click the "+" block inserter and search for "TTT".', 'ttt-commentbox' ); ?></span>
                </div>
                <div class="ttt-intro-step">
                    <span class="ttt-intro-step-num">3</span>
                    <span><?php esc_html_e( 'Select "TTT Comments List" or "TTT Comments Form" from the "TTT CommentBox" category.', 'ttt-commentbox' ); ?></span>
                </div>
                <div class="ttt-intro-step">
                    <span class="ttt-intro-step-num">4</span>
                    <span><?php esc_html_e( 'Use the right-side Settings panel to configure the block appearance.', 'ttt-commentbox' ); ?></span>
                </div>
                <div class="ttt-intro-step">
                    <span class="ttt-intro-step-num">5</span>
                    <span><?php esc_html_e( 'Publish — the block will render as a live comment list/form on the frontend.', 'ttt-commentbox' ); ?></span>
                </div>
            </div>
        ...
        <!-- Classic Editor -->
        <div class="ttt-intro-howto-block">
            <h2>📝 <?php esc_html_e( 'Classic Editor', 'ttt-commentbox' ); ?></h2>
            ...
            <div class="ttt-intro-steps">
                <div class="ttt-intro-step">
                    <span class="ttt-intro-step-num">1</span>
                    <span><?php esc_html_e( 'Open a post in the Classic Editor.', 'ttt-commentbox' ); ?></span>
                </div>
                <div class="ttt-intro-step">
                    <span class="ttt-intro-step-num">2</span>
                    <span><?php esc_html_e( 'Click the 💬 button in the toolbar (labeled "TTT CommentBox").', 'ttt-commentbox' ); ?></span>
                </div>
                <div class="ttt-intro-step">
                    <span class="ttt-intro-step-num">3</span>
                    <span><?php esc_html_e( 'Switch between the "Comments List" and "Comments Form" tabs in the popup.', 'ttt-commentbox' ); ?></span>
                </div>
                <div class="ttt-intro-step">
                    <span class="ttt-intro-step-num">4</span>
                    <span><?php esc_html_e( 'Fill in your settings — title, like button, avatar size, colors, labels.', 'ttt-commentbox' ); ?></span>
                </div>
                <div class="ttt-intro-step">
                    <span class="ttt-intro-step-num">5</span>
                    <span><?php esc_html_e( 'Click "Insert Shortcode" — the shortcode is inserted at your cursor position.', 'ttt-commentbox' ); ?></span>
                </div>
            </div>

            <h3><?php esc_html_e( 'Way 2: Direct Shortcode (advanced)', 'ttt-commentbox' ); ?></h3>
            ...
            <div class="ttt-intro-shortcode-block">
                ...
                <table class="ttt-intro-params">
                    ...
                    <tbody>
                        ...
                        <tr><td><code>list_title</code></td><td>text</td><td>TTTWorks Discuss</td><td><?php esc_html_e( 'Title text above the comment list', 'ttt-commentbox' ); ?></td></tr>
                        <tr><td><code>list_title_show</code></td><td>0/1</td><td>0</td><td><?php esc_html_e( 'Show or hide the list title', 'ttt-commentbox' ); ?></td></tr>
                ...
                <p class="ttt-intro-hint"><?php esc_html_e( 'Basic usage: avatar 32px, like button on, title "TTTWorks Discuss".', 'ttt-commentbox' ); ?></p>
            ...
            <div class="ttt-intro-shortcode-block">
                ...
                <table class="ttt-intro-params">
                    ...
                    <tbody>
                        ...
                        <tr><td><code>form_title_show</code></td><td>0/1</td><td>0</td><td><?php esc_html_e( 'Show or hide the form title', 'ttt-commentbox' ); ?></td></tr>
...
[ttt_comment_form form_title="Join the Conversation"]</code></pre>
        ...
        <div class="ttt-intro-howto-block">
            ...
            <div class="ttt-intro-steps">
                <div class="ttt-intro-step">
                    <span class="ttt-intro-step-num">🙋</span>
                    <span><?php esc_html_e( 'Guests: First character(s) of their name displayed in a colored circle. "Alice" → "A", "张三" → "张", "Alice Wang" → "AW".', 'ttt-commentbox' ); ?></span>
                </div>
                <div class="ttt-intro-step">
                    <span class="ttt-intro-step-num">👤</span>
                    <span><?php esc_html_e( 'Registered users: Continue using their Gravatar or local avatar as normal. No change.', 'ttt-commentbox' ); ?></span>
                </div>
                <div class="ttt-intro-step">
                    <span class="ttt-intro-step-num">🎨</span>
                    <span><?php esc_html_e( 'Colors: 10 preset colors, auto-assigned based on name hash — same name always gets the same color.', 'ttt-commentbox' ); ?></span>
                </div>
                <div class="ttt-intro-step">
                    <span class="ttt-intro-step-num">⚡</span>
                    <span><?php esc_html_e( 'Performance: No external HTTP requests. Zero latency.', 'ttt-commentbox' ); ?></span>
                </div>
            </div>

            <h3><?php esc_html_e( 'How to Enable in Each Editor', 'ttt-commentbox' ); ?></h3>
        ...
        <div class="ttt-intro-howto-block">
            ...
            <div class="ttt-intro-grid ttt-intro-grid-two" style="margin-bottom:0;">
                <div class="ttt-intro-card">
                    <div class="ttt-intro-card-icon">✅</div>
    ...
    <!-- About the Developer -->
    <h2 class="ttt-intro-section-title"><?php esc_html_e( 'About the Developer', 'ttt-commentbox' ); ?></h2>

    <div class="ttt-intro-howto" style="margin-bottom:40px;">
        <div class="ttt-intro-howto-block">
            <div class="ttt-intro-about">
                <p>
                    ...
                    <strong><?php esc_html_e( 'Tientsin Tesseract Technology Co., Ltd.', 'ttt-commentbox' ); ?> (TTTWorks)</strong>.
                ...
                <p>
                    <a href="https://tttworks.com" target="_blank">tttworks.com</a>
                    · <a href="https://github.com/tttworks" target="_blank">GitHub @tttworks</a>
                    · <a href="mailto:a@tttworks.com">a@tttworks.com</a>
                </p>
            </div>

            <div class="ttt-intro-grid ttt-intro-grid-two" style="margin-top:28px; margin-bottom:0;">
                <div class="ttt-intro-card">
                    <div class="ttt-intro-card-icon">🚀</div>
                    ...
                    <p style="margin-top:12px;"><a href="https://github.com/tttworks" target="_blank" class="button"><?php esc_html_e( 'View All Plugins', 'ttt-commentbox' ); ?></a></p>
                </div>
                <div class="ttt-intro-card">
                    <div class="ttt-intro-card-icon">💡</div>
                    ...
                    <p style="margin-top:12px;">
                        <a href="mailto:a@tttworks.com" class="button" style="background:#343CED !important; border-color:#343CED !important; color:#fff !important;"><?php esc_html_e( 'Contact TTTWorks', 'ttt-commentbox' ); ?></a>
                        <a href="https://tttworks.com" target="_blank" class="button" style="margin-left:8px;"><?php esc_html_e( 'Visit Website', 'ttt-commentbox' ); ?></a>
                    </p>
                </div>
            </div>
        </div>
